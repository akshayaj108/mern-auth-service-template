...
exports.Migration1779447493845 = void 0;
class Migration1779447493845 {
    name = "Migration1779447493845";
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "email" character varying NOT NULL, "pass" character varying NOT NULL, "role" character varying NOT NULL, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
...
exports.Migration1779447493845 = Migration1779447493845;
//# sourceMappingURL=1779447493845-migration.js.map